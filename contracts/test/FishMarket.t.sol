...
contract FishMarketTest is Test {
    ...
    function testPriceRecoveryAfter6Hours() public {
        ...
        assertGe(priceAfter6Hours, basePrice * 99 / 100, "Price should recover to at least 99% of base price after 6 hours");
    }
    ...
    function _addTestEngines() private {
        ...
        engineRegistry.registerEngine(
            1, "Test Engine", 30, 100, 1, 1, engineShape, 100 * 10 ** 18, 50
        );
    }
    ...
    function _addTestFishingRods() private {
        ...
        fishingRodRegistry.registerFishingRod(
            1, "Test Fishing Rod", 1, 1, rodShape, 50 * 10 ** 18, 10
        );
    }
